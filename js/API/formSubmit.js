        ...
        .then((data) => {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                entrenadores.forEach((entrenador) => {
                    ...
                    phone.innerHTML = `<td><a href="${entrenador.phone}" aria-label="numero de contacto del entrenador ${entrenador.nick}" target="_blank"><i class="bi bi-whatsapp registros__icon registros__icon--wsp" ></i></a></td>`
                    // phone.classList.add('phone')

                    let image = document.createElement('td')
                    image.innerHTML = `<td><a href="${entrenador.image}" aria-label="Imagen de referencia del perfil del jugador ${entrenador.nick}" target="_blank"><i class="bi bi-images registros__icon registros__icon--img"></i></a></td>`
